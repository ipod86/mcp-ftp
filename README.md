...
| `sync_directory` | Upload only new or changed files (size-based, like rsync) |
| `write_text_file` | Write text content directly to a file on the server (no exchange needed) |
